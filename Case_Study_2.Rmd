...
```
Again we see that thetige.  question 4 and 23 are problematic. To see if we should exclude them we look at the questionaire. Both question related to prestige therefore we leave them in and factor 9 is prestige. 
