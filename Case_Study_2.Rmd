...
In this part we fit a multiple linear regression on the data. 
...
Here we fit the model of willingnes to pay premium and do the variable importance.
...
Comparing the results we see that the pca and fa deliver similar results. Every question is assigned to the same factor. The only thing that varies are the loadings themselves. 
